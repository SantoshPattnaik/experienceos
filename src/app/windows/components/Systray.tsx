...
const Systray = () => {
	...
	return (
		<div className="pt-5 mr-4">
			...
			{/* System Tray */}
			{trayShow && (
				<div className="windows_AnimateFromBottom absolute bottom-16 pl-3 pr-3 pt-3 pb-3 rounded-xl right-52 ">
					<ul>
						<li className="hover:cursor-pointer flex space-x-4 backdrop-blur-3xl">
							<Image src={vscode} alt="" height={18} width={18} />
							<Image src={github} alt="" height={18} width={18} />
							<Image src={blender} alt="" height={18} width={18} />

							<Image src={vs} alt="" height={18} width={18} />
							<Image src={ae} alt="" height={18} width={18} />
						</li>
					</ul>
				</div>
			)}
